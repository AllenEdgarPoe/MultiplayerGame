...
//충돌감지
testCollisionObject = function (Object1,Object2){	//return if colliding (true/false)
	var rect1 = {
...
update = function(){
	...
	for(var key in monsterList){
		updateObject(monsterList[key]);
		
		var isColliding = testCollisionObject(player,monsterList[key]);
		if(isColliding=0){
